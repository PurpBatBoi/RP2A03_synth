#![allow(dead_code)]
// this is copied wholesale from https://github.com/obsqrbtz/egui_knob
// since i need to make some small internal adjustments and can't be fucked
// to fork an entire extra dependency for one file
...
impl Widget for Knob<'_> {
    fn ui(self, ui: &mut Ui) -> Response {
        ...
        let angle = (self.value.clamp(self.min, self.max) - self.min) / (self.max - self.min) * std::f32::consts::PI * 1.5
